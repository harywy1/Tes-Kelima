             ...
             <div className={classes.search}>
              ...
              />
                ...
                <Grid>
                    ...
                    <Button variant="raised" color="text">FOLLOWERS</Button>
                    </NavLink>
                    <NavLink path to="/src/component/Favorites.js">
                    <Button variant="raised" color="text">FAVORITES</Button>
                    </NavLink>
                    <NavLink path to="/src/component/Recent.js">
                    <Button variant="raised" color="text">RECENT</Button>
                    </NavLink>
                    <NavLink path to="/src/component/Popular.js">
                    <Button variant="raised" color="text">POPULAR</Button>
                    </NavLink>
                    </div>
                </Grid>
